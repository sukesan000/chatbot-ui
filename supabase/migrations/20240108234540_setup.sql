...
AS $$
DECLARE
  project_url TEXT := 'https://upixswwcaexbtymgtepp.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InVwaXhzd3djYWV4YnR5bWd0ZXBwIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTcyNDU1OTk1NSwiZXhwIjoyMDQwMTM1OTU1fQ.u_zQh3xmRbL3_b8cdA9jF-0Bgy11DB5pxWjlqdbikxk'; -- full access needed for http request to storage
